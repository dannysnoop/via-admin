...
import { ProductDetailCreateRequest, ProductDetailUpdateRequest, ProductSearchRequest, UidRequest } from "./DTO/product-detail.dto";
...
export declare class ProductDetailController {
    ...
    checkLiveUid(params: UidRequest): Promise<boolean>;
